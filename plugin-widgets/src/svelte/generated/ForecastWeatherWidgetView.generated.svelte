...
<gridlayout width={size.width} height={size.height} {...$$restProps} class="widget-container">
    <stacklayout orientation="vertical">
        <gridlayout row="auto" paddingLeft={Math.min(size.width * 0.05, 10)} paddingRight={Math.min(size.width * 0.05, 10)} paddingTop={Math.min(size.height * 0.07, 6)} paddingBottom={Math.min(size.height * 0.07, 6)} columns="auto,*,auto" horizontalAlignment="center" verticalAlignment="top">
        ...
        <collectionview items={data.hourlyData?.slice(0, 8)} orientation="horizontal" colWidth="auto" horizontalAlignment="center" verticalAlignment="top">
            ...
            <stacklayout width={53} padding={2} paddingLeft={4} paddingRight={4} orientation="vertical">
                ...
                <image src={iconService.getIconPath(item.iconPath, true, false, config.iconSet)} width={28} height={28} horizontalAlignment="center" verticalAlignment="center"></image>
